...
import { ModulesItem } from '~bridge/ui/components/ModulesList/ModulesItem';
import { CreateModuleConfigModal } from '~bridge/ui/components/Dialogs';
...
export const ModulesList: FC<ModulesListProps> = ({ pack }) => {
    ...
    return (
        <Box sx={{ paddingLeft: '50px' }}>
            ...
            <CreateModuleConfigModal open={createModule} onClose={closeCreateModuleModal} packName={pack.pack.name} author={pack.pack.author} />
        </Box>
    )
}