        ...
        <Grid container spacing={2} sx={{ paddingTop: '16px' }}>
            ...
            <Grid item xs={12}>
                <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                        <Tooltip title="SLAL JSON config file - please provide path to slal config. It will help app to make more precise first run of copying hkx files and making first scene xml files.">
                            <TextFieldFile
                                {...field}
